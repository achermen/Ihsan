...
export class BeneficiaireModel {
    ...
    descriptionBeneficiaire: string;
    ...
    constructor(numeroDossier: string, cin: string, nom: string, prenom: string, telephone: string, adresse: string
        ...
        descriptionMaladieChronique: string, ville: string, etatDossier: string, typeHandicap: string, etatCivil: string,
        typeMaladieChronique: string, descriptionBeneficiaire: string) {
        ...
        this.descriptionBeneficiaire = descriptionBeneficiaire;
    }
}